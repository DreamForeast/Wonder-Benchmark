(function (global, factory) {
	...
	// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
	var Check_fail = create("Exception-Wonderjs.Check_fail");
	...
	function createGL(contextConfig, canvas) {
	  return getContext(canvas, contextConfig);
	}
	...
	function getFullScreenData$1() {
	  return getFullScreenData(/* () */0);
	}

	function setToFullScreen$1(screenData, gl, canvas, state) {
	  return /* tuple */[
	          setViewport(gl, screenData[0], screenData[1], screenData[2], screenData[3], state),
	          setToFullScreen(screenData, canvas)
	        ];
	}
	...
	function init(param) {
	  ...
	  var gl = createGL(config[/* contextConfig */2], canvas);
	  var match = setToFullScreen$1(getFullScreenData$1(/* () */0), gl, canvas, param[1]);
	  return initDataFromState(detect(gl, setConfig$1(config[/* gpuConfig */4], setConfig$2(config[/* bufferConfig */3], setContextConfig(config[/* contextConfig */2], setCanvas(match[1], setGl(gl, match[0])))))));
	}
	...
	// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
	var createGameObject$1 = create$1;
